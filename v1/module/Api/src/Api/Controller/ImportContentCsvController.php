...
use Api\Model\ImportContentCsvForm;

class ImportContentCsvController extends CommonController
{
	public function indexAction()
	{
		try {
			...
			$importContentCsvForm = new ImportContentCsvForm($this->getServiceLocator());
			$resultCode = $importContentCsvForm->import($params);
		} catch (\Exception $e) {
			if ($e->getCode() == 0) {
